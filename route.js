...
function route(handle, pathname, getData, response)
{
	if (typeof handle[pathname] === 'function') {
		...
		var htm= '<!DOCTYPE html><html><head><script>function onLoading(){var xmlHttp = new XMLHttpRequest();' 
					...
					+'};'
					+'xmlHttp.open("GET", "http://ec2-54-209-229-219.compute-1.amazonaws.com:1337/onLoading?dataType=3", true);'
					+'xmlHttp.send();}'
					...
					+'};'
					+'var url = "http://ec2-54-209-229-219.compute-1.amazonaws.com:1337/subjectExpand?subject=" +sub+"&dataType=3";'
					...
					+'};'
					+'var url = "http://ec2-54-209-229-219.compute-1.amazonaws.com:1337/classExpand?subject="+sub+"&classID="+classID+"&dataType=3"; document.getElementById("sectionList").innerHTML = "pls";'
					+'xmlHttp.open("GET",url,true);'
					+'xmlHttp.send();}'
					...
					+'};'
					+'var url = "http://ec2-54-209-229-219.compute-1.amazonaws.com:1337/sectionExpand?subject="+sub+"&classID="+classID+"&section="+sec+"&dataType=3";'
					+'xmlHttp.open("GET",url,true);'
					+'xmlHttp.send();}'
					+'function fileUpload(){var xmlHttp = new XMLHttpRequest();'
					+'xmlHttp.onreadystatechange=function(){};'
					+'xmlHttp.open("GET", "http://ec2-54-209-229-219.compute-1.amazonaws.com:1337/fileUpload", true);'
					+'xmlHttp.send();}'
					+'</script></head>'
