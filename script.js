...
function loadTest(){
	...
	if(loadTest == 'true'){
		...
		xmlHttp.open("GET", 'http://basicpoc.elasticbeanstalk.com:8081/loadTest?loadTest='+loadTest+'&databaseType='+databaseType, true);
		xmlHttp.send();
	}
}
...
function onLoading(){
	...
	xmlHttp.open("GET", "http://basicpoc.elasticbeanstalk.com:8081/onLoading?databaseType="+databaseType, true);
	xmlHttp.send();
}
...
function subjectExpand(sub){
	...
	var url = "http://basicpoc.elasticbeanstalk.com:8081/subjectExpand?subject=" +sub+"&databaseType="+databaseType;
...
function courseExpand(courseID, sub){
	...
	var url = "http://basicpoc.elasticbeanstalk.com:8081/courseExpand?subject="+sub+"&courseID="+courseID+"&databaseType="+databaseType;
	xmlHttp.open("GET",url,true);
	xmlHttp.send();
}
...
function sectionExpand(sub, courseID, sec){
	...
	var url = "http://basicpoc.elasticbeanstalk.com:8081/sectionExpand?subject="+sub+"&courseID="+courseID+"&section="+sec+"&databaseType="+databaseType;
	xmlHttp.open("GET",url,true);
	xmlHttp.send();
}
...
function fileUpload(subj ,courseID, sect){var xmlHttp = new XMLHttpRequest();
	...
	var url = "http://basicpoc.elasticbeanstalk.com:8081/fileUpload?subject="+subj+"&courseID="+courseID+"&section="+sect;
	xmlHttp.open("GET", url, true);
	xmlHttp.send();
}
function cacheIt(subj,course){ var xmlHttp = new XMLHttpRequest();
	...
	var url = "http://basicpoc.elasticbeanstalk.com:8081/cacheIt?key="+subj+"&value="+course+"&cacheType="+cacheType;
	xmlHttp.open("GET", url, true);
	xmlHttp.send();
}
